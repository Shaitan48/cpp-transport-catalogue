...
public:
    ...
    std::vector<svg::Circle> GetStopsSymbols(const std::map<std::string_view, const transportCatalog::Stop*>& stops, const SphereProjector& sp) const;
    std::vector<svg::Text> GetStopsLabels(const std::map<std::string_view, const transportCatalog::Stop*>& stops, const SphereProjector& sp) const;
